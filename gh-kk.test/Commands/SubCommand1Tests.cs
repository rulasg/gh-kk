...
public class SubCommand1Tests
{
    ...
    public void Invoke_WithBasicParameters_OutputsCorrectMessage()
    {
        ...
        var owner = "testowner";
        var number = 123;
        var args = new string[] { "subcommand1", owner, number.ToString() };

        var consoleOutput = cmdTest.RunAndGetConsoleOutput(args);

        // Assert
        Assert.Contains($"Called SubCommand1 {number} owned by {owner}.", consoleOutput);
    ...
    public void Invoke_WithDescription_IncludesDescriptionInOutput()
    {
        ...
        var args = new string[] { "subcommand1", owner, number.ToString(), "--description", description };
    ...
    public void Invoke_WithVerboseFlag_IncludesVerboseMessageInOutput()
    {
        ...
        var owner = "testowner";
        var number = 123;
        var args = new string[] { "subcommand1", owner, number.ToString(), "--verbose" };
